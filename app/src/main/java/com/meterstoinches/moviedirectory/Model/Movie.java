package com.meterstoinches.moviedirectory.Model;

import java.io.Serializable;

public class Movie implements Serializable {
    //Serializable: makes the object of this class pass it around easily between activities

    public static final long id = 1L;
    //Serializable: it is important to give them id, we may not use them
